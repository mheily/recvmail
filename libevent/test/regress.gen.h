...
void evtag_marshal_msg(struct evbuffer *, uint8_t, 
    const struct msg *);
int evtag_unmarshal_msg(struct evbuffer *, uint8_t,
    struct msg *);
...
void evtag_marshal_kill(struct evbuffer *, uint8_t, 
    const struct kill *);
int evtag_unmarshal_kill(struct evbuffer *, uint8_t,
    struct kill *);
...
void evtag_marshal_run(struct evbuffer *, uint8_t, 
    const struct run *);
int evtag_unmarshal_run(struct evbuffer *, uint8_t,
    struct run *);
